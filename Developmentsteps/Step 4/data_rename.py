...
DATEI UMBENENNUNG 
-----------------
- Dateien in Schweißkurvennummer umbenennen, wenn im Dateinamen außer der Schweißkurvennummer noch andere Bestandteile enthalten sind
- csv-Dateien mit Zugfestigkeiten übertragen 
- betrifft ok und leoni 
- von Verzeichnis "Rohdaten" → in "Rohdaten_renamed" 
"""

import os, re, shutil

SRC_DIR = 'Rohdaten/'          # source directory
TGT_DIR = 'Rohdaten_renamed/'  # target directory

INCLUDES = ['ok', 'near_ok_sonowechsel', 
            'fehler_leitungsversatz', 'fehler_oel', 'fehler_terminversatz',
            'nolabel_ok_leoni', 'gg-group']
